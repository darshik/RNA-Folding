...
import de.unibi.bibiserv.rnamovies.configuration.ConfigChangedEvent;
import de.unibi.bibiserv.rnamovies.configuration.ConfigListener;
...
public class MoviePane extends JComponent implements Runnable, Movie, ConfigListener {
    ...
    private static Logger log = Logger.getLogger("MoviePane");
