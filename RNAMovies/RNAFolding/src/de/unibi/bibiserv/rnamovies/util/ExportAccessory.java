...
public class ExportAccessory extends JPanel implements PropertyChangeListener{
    ...
    private static Logger log = Logger.getLogger(ExportAccessory.class.getName());
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        if (prop.equals("fileFilterChanged")) {
            ...
            try {
                if (evt.getNewValue().getClass().getName().equals("de.unibi.bibiserv.rnamovies.actions.Export$GIFFilter")){
                    fps.setEnabled(true);
                ...
                if(evt.getNewValue().getClass().getName().equals("de.unibi.bibiserv.rnamovies.actions.Export$JPGFilter")){
